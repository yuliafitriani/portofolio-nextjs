...
const RoundedCardBordered = React.forwardRef<HTMLDivElement, RoundedCardProps>(
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "rounded-full",
          "p-0.25 transition-all duration-300",
      ...
      >
        ...
        >
          <span className="text-neutral-100 font-bold text-4xl">{value}</span>
...
RoundedCardBordered.displayName = "RoundedCardBordered";

export default RoundedCardBordered;
